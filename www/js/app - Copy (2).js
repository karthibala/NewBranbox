                                    ...
                                    db.transaction(function(tx){
                                       ...
                                       // alert("hiii"+ albumData.length);
                                        ...
                                        tx.executeSql("SELECT * FROM  album", [], function(tx, results) {
                                            //alert("SELECT QUERY album");
                                            //alert("album->"+results.rows.length);
                                        });
                                    });
                                    /* gallery */
                                    var galleryData = [];
                                    galleryData[0] ={"id":"60","businessId":"1","galId":"1","name":"20151217144730.png","size":"","link":"img/Zoom/chief/chief1.jpg","active":"ON","createdTime":"2016-01-29 15:20:21"};
                                    galleryData[1] ={"id":"62","businessId":"1","galId":"7","name":"20160128155446.png","size":"","link":"img/Zoom/chief/chief2.JPG","active":"ON","createdTime":"2016-02-08 14:51:56"};
                                    galleryData[2] ={"id":"63","businessId":"1","galId":"1","name":"20160128155446.png","size":"","link":"img/Zoom/chief/chief3.jpg","active":"ON","createdTime":"2016-02-08 14:51:56"};
                                    db.transaction(function(tx){
                                        ...
                                        tx.executeSql("SELECT * FROM  gallery", [], function(tx, results) {
                                            //alert("SELECT QUERY gallery");
                                            //alert("gallery->"+results.rows.length);
                                        });
                                    });
                                    /* Video */
                                    var videoGalleryData = [];
                                    videoGalleryData[0]={"id":"6","businessId":"1","videoName":"big_buck_bunny.mp4","videoUrl":"img/Zoom/videos/big_buck_bunny.mp4","status":"ON","createdTime":"2015-10-23 09:43:59","modified_date":"2016-02-13 08:01:38"};
                                    db.transaction(function(tx){
